    ...
    <div class="container py-1">
        <div class="row g-5 align-items-center">
            <div class="card shadow p-3 mb-5 bg-white rounded animated slideInDown">
                <div class="card-body">
                    <h4 style="text-align: center">Tambah Buku</h4>
                    <form action="/buku/insert" method="POST" enctype="multipart/form-data">
                        @csrf
                        <h6 class="form-label" for="form6Example3">Kode Buku</h6>
                        <div class="form-outline mb-4">
                          <input type="text" style="color: black" placeholder="Masukkan Kode Buku" name="kode_buku" class="form-control" />
                        ...
                        <div class="form-outline mb-4">
                          <input type="text" style="color: black" placeholder="Masukkan Nama Buku" name="nama_buku" class="form-control" />
                          <div class="text-danger">
                            @error('nama_buku')
                                {{$message}}
                            @enderror
                        ...
                        <div class="form-outline mb-4">
                          <input type="text" style="color: black" placeholder="Masukkan Penulis Buku" name="penulis_buku" class="form-control" />
                          <div class="text-danger">
                            @error('penulis_buku')
                                {{$message}}
                            @enderror
